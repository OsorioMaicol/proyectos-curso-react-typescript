import { itemId, itemsCart } from "../types"

type HeaderProps = {
    cart: itemsCart[],
    removeItemCart: (cart: itemId) => void,
    incrementCart: (id: itemId) => void,
    decrementItem: (id: itemId) => void,
    clearCart: () => void,
    isEmpty: boolean,
    totalCart: number
}

export default function Header({cart, removeItemCart, incrementCart, decrementItem, clearCart, isEmpty, totalCart} :HeaderProps) {
